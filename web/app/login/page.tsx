    ...
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#F8F9FA' }}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold" style={{ color: '#1A1A2E' }}>Welcome to Kharcha</h1>
          <p className="text-sm mt-1" style={{ color: '#877273' }}>Sign in to track your expenses</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border p-8" style={{ borderColor: '#E5E7EB' }}>
          ...
          <p className="text-center text-sm mt-6" style={{ color: '#877273' }}>
            ...
            <Link href="/signup" className="font-medium" style={{ color: '#E94560' }}>Sign up</Link>
          </p>
        </div>
      </div>
    </div>
